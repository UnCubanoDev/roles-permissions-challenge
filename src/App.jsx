...
function App() {
  ...
  const permissions = ["PROJECT:WRITE", "PROJECT:READ", "PROJECT:DELETE", "USER:WRITE", "USER:READ", "USER:DELETE", "STORAGE:WRITE", "STORAGE:READ", "STORAGE:DELETE", , "ADMIN:WRITE", "ADMIN:READ", "ADMIN:DELETE", "CODE:WRITE", "CODE:READ", "CODE:DELETE", "BUSINESS:WRITE", "BUSINESS:READ", "BUSINESS:DELETE", "SERVER:WRITE", "SERVER:READ", "SERVER:DELETE", "BACKEND:WRITE", "BACKEND:READ", "BACKEND:DELETE", "FRONTEND:WRITE", "FRONTEND:READ", "FRONTEND:DELETE"]
